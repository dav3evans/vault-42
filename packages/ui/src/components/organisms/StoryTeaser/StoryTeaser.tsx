  ...
  return (
    <section className={cn("border-y border-gold/8 bg-bg-2/40 py-[86px]", className)}>
      <div className="mx-auto grid max-w-(--container-max) grid-cols-1 items-center gap-7 px-3.5 lg:grid-cols-[1fr_430px]">
        ...
        <div className="min-h-[420px] overflow-hidden rounded-[22px] border border-white/5 bg-gradient-to-b from-black/[0.14] to-black/[0.46] shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
          {media}
        </div>
      </div>
    </section>
